...
namespace EFCoreSqlite.Models
{
  ...
  public class NpcNames
  {
    ...
    public NpcNames(int id, string originalNpcName, string originalNpcNameLang, string translatedNpcName, string translationLang, int translationEngine, DateTime createdDate, DateTime? updatedDate, byte[] rowVersion)
    {
      this.Id = id;
